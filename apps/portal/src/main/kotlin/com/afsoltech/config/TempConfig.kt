...
@Configuration
class TempConfig(val userRepository: UserAppRepository, val bCryptPasswordEncoder: BCryptPasswordEncoder) {
    ...
    fun initUsers() = CommandLineRunner {
        ...
        val userAdmin = UserApp(login = "admin", password = bCryptPasswordEncoder.encode("admin0"),
