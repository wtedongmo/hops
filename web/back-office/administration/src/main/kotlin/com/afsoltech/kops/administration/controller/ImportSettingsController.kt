...
import com.afsoltech.core.service.security.setting.ImportSettingsEntitiesService
...
import com.afsoltech.kops.administration.utils.FileBucket
import com.afsoltech.kops.administration.utils.FileValidator
import mu.KLogging
...
//        } else {
        if (checkAuth.hasAuthorization()) {
            ...
            val model = ModelAndView("redirect:/admin/users?pageNumber=1&success=true")
