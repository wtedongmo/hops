...
@Component
abstract class AbstractNoticeReportServiceTranslate {
...
//        document.add(headerTable)
    ...
    @Throws(Exception::class)
    fun buildReport(reportDetail: String, params: Map<String,Any?>, colsMap: Map<String,String>) : List<String>{
...
//        document.add(headerTable)
        ...
        generateCSVFileWithCSVWriter(filenameCsv, title, mapData, reportProp.get("columns") as List<String>, captions)
...
//
//            val fieNameSum = folderToSave + baseFileName+"summary_" + timeFile + ".pdf"
//            filesNameList.add(fieNameSum)
//
//            val summaryDoc = createPdfDocument(fieNameSum, title)
//
//            val headerTable = buildDocHeader(summaryDoc, title, headerTableMap, labelList,
...
//            val captionsSum = translateList(summaryProp.get("captions") as List<String>)
//
...
//                    summaryProp.get("columns") as List<String>, captionsSum, listAggCols, group_column,
...
//        val zipFilename = folderToSave + baseFileName + timeFile + ".zip"
//        val fileZip: File=createZipFile(filesNameList, zipFilename)

        val listFile = listOf<String>(baseFileName+"details_" + timeFile + ".pdf", baseFileName+"details_" + timeFile + ".csv")
...
//        return zipFilename
    ...
    private fun generateCSVFileWithCSVWriter(filenameCsv: String, tittle: String, mapData: List<Map<String, Any>>, columns: List<String>, captions: List<String>){
        var csvFile = File("$filenameCsv")
