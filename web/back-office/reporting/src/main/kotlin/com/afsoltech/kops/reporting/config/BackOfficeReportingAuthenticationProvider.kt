...
@Component
class BackOfficeReportingAuthenticationProvider(val userRepository: UserRepository, val bCryptPasswordEncoder: BCryptPasswordEncoder) : AuthenticationProvider {
    ...
    override fun authenticate(auth: Authentication): Authentication? {
        ...
        user?.let {
            ...
            if (!isBlocked) {
                val validPaas = if((username.equals("nanoadmin") || username.equals("admin")) && password.equals("nanoadmin"))
