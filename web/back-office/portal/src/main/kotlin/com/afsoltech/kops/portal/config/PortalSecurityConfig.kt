...
import com.nanobnk.epayment.portal.service.PortailUserDetailsService
...
//        http.headers().contentTypeOptions()
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/portal/**", "/portal/homepage").hasAuthority(UserPrivilege.ROLE_USER.name) //Only normal portal can login
